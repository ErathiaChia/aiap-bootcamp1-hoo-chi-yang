...
class Model_Mgr:
    def __init__(self):
        ...
        self.svm_radial_params = {'model__C': [0.1, 1, 10], 'model__kernel': ['rbf'], 'model__gamma': [0.1, 1, 10]}
        self.knn_params = {'model__n_neighbors': [3, 5, 7, 9, 11], 'model__weights': ['uniform', 'distance']}
